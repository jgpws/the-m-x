<?php
/**
 * Search Form for Google AMP pages
 *
 * @package The_M.X.
 */
 ?>
<form role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ) ?>" class="searchform hide" [class]="'searchform' + ( searchbarExpanded ? ' toggled' : ' hide' )" aria-expanded="false" [aria-expanded]="searchbarExpanded ? 'true' : 'false'">
	<label>
