...
(function () {
  ...
  function headerTitleRGBA() {
    var headerTitleCss =
      ...
      "\tcolor: rgba(" +
      hexToR(colorScheme.headerTextColor) +
      ", " +
      hexToG(colorScheme.headerTextColor) +
      ", " +
      hexToB(colorScheme.headerTextColor) +
      ", 0.87);" +
      "\n}\n\n" +
      ".site-title a:hover,\n" +
      ".site-title a:focus {\n" +
  ...
  function addMobileSocialButton() {
    if (socialContainer) {
      socialContainer.insertAdjacentHTML(
        "beforebegin",
        '<button class="social-toggle" id="social-button"><i class="material-icons">&#xE7FD;</i></button>'
      );
    }
  }
    ...
    if (socialContainer) {
      socialToggleButton.onclick = function () {
        if (-1 !== socialContainer.className.indexOf("toggled")) {
          socialContainer.className = socialContainer.className.replace(
            " toggled",
            ""
          );
          socialContainer.classList.add("hide");
  ...
  function socialMediaButtons() {
    ...
    if (document.body.contains(socialContainer)) {
      var fbLink = document.querySelector(
        '#menu-social-items li a[href*="facebook.com"]'
      );
      var twLink = document.querySelector(
        '#menu-social-items li a[href*="twitter.com"]'
      );
      var instLink = document.querySelector(
        '#menu-social-items li a[href*="instagram.com"]'
      );
      var pntLink = document.querySelector(
        '#menu-social-items li a[href*="pinterest.com"]'
      );
      var ytLink = document.querySelector(
        '#menu-social-items li a[href*="youtube.com"]'
      );
      var vimLink = document.querySelector(
        '#menu-social-items li a[href*="vimeo.com"]'
      );
      var flkLink = document.querySelector(
        '#menu-social-items li a[href*="flickr.com"]'
      );
      var gthbLink = document.querySelector(
        '#menu-social-items li a[href*="github.com"]'
      );
      var gpLink = document.querySelector(
        '#menu-social-items li a[href*="plus.google.com"]'
      );
      var tmbLink = document.querySelector(
        '#menu-social-items li a[href*="tumblr.com"]'
      );
      var wpLink = document.querySelector(
        '#menu-social-items li a[href*="wordpress.com"]'
      );
      var wpOrgLink = document.querySelector(
        '#menu-social-items li a[href*="wordpress.org"]'
      );
    ...
    if (document.body.contains(sidebar)) {
      ...
      if (document.body.contains(toggleButton)) {
        ...
        toggleButton.setAttribute(
          "title",
          "Click or press Enter to open/close the sidebar."
        );
  ...
  function addOverlayToSidebar(e) {
    ...
    var overlayStylesheet = document.head.querySelector(
      'link[href*="/layouts/content-sidebar-overlay.css"]'
    );
    ...
    function placeScrim() {
      if (bodyElHeight > window.outerHeight) {
        ...
        theScrim.style.position = "fixed";
        theScrim.style.bottom =
          document.body.clientHeight -
          theSidebar.getBoundingClientRect().height +
          "px";
      }
    }
    ...
    function animateScrim() {
      ...
      if (
        window.pageYOffset >
        theSidebar.getBoundingClientRect().height - window.innerHeight
      ) {
  ...
  function toggleSearchbar() {
    ...
    if (document.body.contains(headerPanel)) {
      // check if headerPanel exists

      if (
        document.body.classList.contains("page-template-template-landing") ||
        ...
        searchContainer = document
          .getElementById("header-button-panel")
          .getElementsByClassName("searchform")[0];
        toggleSearch = document
          .getElementById("header-button-panel")
          .getElementsByClassName("search-toggle")[0];
        ...
        toggleSearch.onclick = function () {
          if (-1 !== searchContainer.className.indexOf("toggled")) {
            searchContainer.className = searchContainer.className.replace(
              " toggled",
              ""
            );
            searchContainer.classList.add("hide");
  ...
  function addDesktopNavButtons() {
    ...
    var hasChildrenLink = document.querySelectorAll(
      ".main-navigation .page_item_has_children > a"
    );
    var customHasChildren = document.querySelectorAll(
      ".main-navigation .menu-item-has-children"
    );
    var customHasChildrenLink = document.querySelectorAll(
    ...
    for (var i = 0; i < customHasChildren.length; i++) {
      ...
      customHasChildrenLink[i].insertAdjacentHTML(
        "afterend",
        '<button class="menu-down-arrow"><i class="material-icons">arrow_drop_down</i></button>'
      );
    }
    ...
    for (var i2 = 0; i2 < hasChildren.length; i2++) {
      ...
      hasChildrenLink[i2].insertAdjacentHTML(
        "afterend",
        '<button class="menu-down-arrow"><i class="material-icons">arrow_drop_down</i></button>'
      );
    }
  ...
  function toggleMenuItems() {
    ...
    var customSubmenuButton = document.querySelectorAll(
      ".main-navigation .menu-down-arrow, .is-style-the-mx-nav .wp-block-navigation-submenu__toggle"
    );
    ...
    for (var iSub = 0; iSub < customSubmenuButton.length; iSub++) {
      ...
      customSubmenuButton[iSub].addEventListener("click", function () {
        ...
        if (
          this.nextElementSibling.className.indexOf("toggled-submenu") !== -1
        ) {
          // if .sub-menu has .toggled-submenu class
          this.nextElementSibling.className =
            this.nextElementSibling.className.replace(" toggled-submenu", ""); // remove it
    ...
    window.addEventListener("click", function (e) {
      ...
      var navBlockSubmenu = document.querySelectorAll(
        ".is-style-the-mx-nav .wp-block-navigation__submenu-container"
      );
  ...
  function loadInitMenuState() {
    ...
    windowWidth = window.innerWidth;
    var customSubmenuButton = document.querySelectorAll(
      ".main-navigation .menu-down-arrow"
    );
    if (typeof menu != "undefined" && menu != null) {
      // if a menu exists on the page
      if (windowWidth < 600) {
  ...
  var gallery = document.querySelectorAll(
    ".single.slider .gallery, .single.slider .wp-block-gallery"
  );

  var galleries = [
    document.querySelector(".single.slider #gallery-1"),
  ...
  var slides = [
    document.querySelectorAll(".single.slider #gallery-1 .gallery-item"),
    ...
    document.querySelectorAll(
      ".single.slider .wp-block-gallery:nth-of-type(1) .wp-block-image"
    ),
    document.querySelectorAll(
      ".single.slider .wp-block-gallery:nth-of-type(2) .wp-block-image"
    ),
    document.querySelectorAll(
      ".single.slider .wp-block-gallery:nth-of-type(3) .wp-block-image"
    ),
    document.querySelectorAll(
      ".single.slider .wp-block-gallery:nth-of-type(4) .wp-block-image"
    ),
    document.querySelectorAll(
      ".single.slider .wp-block-gallery:nth-of-type(5) .wp-block-image"
    ),
    document.querySelectorAll(
      ".single.slider .wp-block-gallery:nth-of-type(1) .blocks-gallery-item"
    ),
    document.querySelectorAll(
      ".single.slider .wp-block-gallery:nth-of-type(2) .blocks-gallery-item"
    ),
    document.querySelectorAll(
      ".single.slider .wp-block-gallery:nth-of-type(3) .blocks-gallery-item"
    ),
    document.querySelectorAll(
      ".single.slider .wp-block-gallery:nth-of-type(4) .blocks-gallery-item"
    ),
    document.querySelectorAll(
      ".single.slider .wp-block-gallery:nth-of-type(5) .blocks-gallery-item"
    ),
  ];
  var i, len;
  ...
  function showFirstSlide(arrayOfGals, arrayOfSlides) {
    ...
    for (var iGal = 0, len = arrayOfGals.length; iGal < len; iGal++) {
      ...
      for (
        var jSlide = 0, lenSlide = arrayOfSlides.length;
        jSlide < lenSlide;
        jSlide++
      ) {
        ...
        for (
          var kEachSlide = 0;
          kEachSlide < arrayOfSlides[jSlide].length;
          kEachSlide++
        ) {
  ...
  for (i = 0, len = gallery.length; i < len; i++) {
    ...
    gallery[i].insertAdjacentHTML(
      "afterend",
      '<div class="slider-button-panel"><button class="slider-previous"><i class="material-icons">skip_previous</i></button><button class="slider-startshow"><i class="material-icons">play_arrow</i></button><button class="slider-next"><i class="material-icons">skip_next</i></button></div>'
    );
    //console.log(gallery.length);
  }

  // Variables that are defined after our dynamically created buttons/panel
  var buttonPanel = document.querySelectorAll(
    ".single.slider .slider-button-panel"
  );

  var sliderNext = [
    document.querySelector(
      ".single.slider #gallery-1 + .slider-button-panel .slider-next"
    ),
    document.querySelector(
      ".single.slider #gallery-2 + .slider-button-panel .slider-next"
    ),
    document.querySelector(
      ".single.slider #gallery-3 + .slider-button-panel .slider-next"
    ),
    document.querySelector(
      ".single.slider #gallery-4 + .slider-button-panel .slider-next"
    ),
    document.querySelector(
      ".single.slider #gallery-5 + .slider-button-panel .slider-next"
    ),
    document.querySelector(
      ".single.slider .wp-block-gallery:nth-of-type(1) + .slider-button-panel .slider-next"
    ),
    document.querySelector(
      ".single.slider .wp-block-gallery:nth-of-type(2) + .slider-button-panel .slider-next"
    ),
    document.querySelector(
      ".single.slider .wp-block-gallery:nth-of-type(3) + .slider-button-panel .slider-next"
    ),
    document.querySelector(
      ".single.slider .wp-block-gallery:nth-of-type(4) + .slider-button-panel .slider-next"
    ),
    document.querySelector(
      ".single.slider .wp-block-gallery:nth-of-type(5) + .slider-button-panel .slider-next"
    ),
  ];

  var sliderPrevious = [
    document.querySelector(
      ".single.slider #gallery-1 + .slider-button-panel .slider-previous"
    ),
    document.querySelector(
      ".single.slider #gallery-2 + .slider-button-panel .slider-previous"
    ),
    document.querySelector(
      ".single.slider #gallery-3 + .slider-button-panel .slider-previous"
    ),
    document.querySelector(
      ".single.slider #gallery-4 + .slider-button-panel .slider-previous"
    ),
    document.querySelector(
      ".single.slider #gallery-5 + .slider-button-panel .slider-previous"
    ),
    document.querySelector(
      ".single.slider .wp-block-gallery:nth-of-type(1) + .slider-button-panel .slider-previous"
    ),
    document.querySelector(
      ".single.slider .wp-block-gallery:nth-of-type(2) + .slider-button-panel .slider-previous"
    ),
    document.querySelector(
      ".single.slider .wp-block-gallery:nth-of-type(3) + .slider-button-panel .slider-previous"
    ),
    document.querySelector(
      ".single.slider .wp-block-gallery:nth-of-type(4) + .slider-button-panel .slider-previous"
    ),
    document.querySelector(
      ".single.slider .wp-block-gallery:nth-of-type(5) + .slider-button-panel .slider-previous"
    ),
  ];

  var slideshowBtn = [
    document.querySelector(
      ".single.slider #gallery-1 + .slider-button-panel .slider-startshow"
    ),
    document.querySelector(
      ".single.slider #gallery-2 + .slider-button-panel .slider-startshow"
    ),
    document.querySelector(
      ".single.slider #gallery-3 + .slider-button-panel .slider-startshow"
    ),
    document.querySelector(
      ".single.slider #gallery-4 + .slider-button-panel .slider-startshow"
    ),
    document.querySelector(
      ".single.slider #gallery-5 + .slider-button-panel .slider-startshow"
    ),
    document.querySelector(
      ".single.slider .wp-block-gallery:nth-of-type(1) + .slider-button-panel .slider-startshow"
    ),
    document.querySelector(
      ".single.slider .wp-block-gallery:nth-of-type(2) + .slider-button-panel .slider-startshow"
    ),
    document.querySelector(
      ".single.slider .wp-block-gallery:nth-of-type(3) + .slider-button-panel .slider-startshow"
    ),
    document.querySelector(
      ".single.slider .wp-block-gallery:nth-of-type(4) + .slider-button-panel .slider-startshow"
    ),
    document.querySelector(
      ".single.slider .wp-block-gallery:nth-of-type(5) + .slider-button-panel .slider-startshow"
    ),
  ];
