...
(function () {
  ...
  function animateMenu() {
    ...
    let menuDropdownButton = document.querySelectorAll(
      ".main-navigation .menu-down-arrow, .is-style-the-mx-nav .open-on-hover-click .wp-block-navigation-submenu__toggle"
    );
    let menuDropdownOnClick = document.querySelectorAll(
      ".is-style-the-mx-nav .open-on-click .wp-block-navigation-submenu__toggle"
    ); // Block editor- reveal submenu from clicking title
    ...
    if (viewportWidth >= 600) {
      ...
      window.addEventListener("click", function (e) {
        ...
        var navBlockBtn = document.querySelectorAll(
          ".is-style-the-mx-nav .open-on-hover-click .wp-block-navigation-submenu__toggle"
        );
        ...
        if (document.body.contains(navBlock) && !navBlock.contains(e.target)) {
          for (let i = 0, len = navBlockSubmenu.length; i < len; i++) {
            ...
            navBlockSubmenu[i].classList.add(
              "animate__fadeOutDown",
              "toggled-submenu"
            );
    ...
    if (viewportWidth < 600) {
      if (
        typeof mobileMenuCustom !== "undefined" &&
        mobileMenuCustom !== null
      ) {
        menuButton.addEventListener("click", function () {
          if (mainMenu.classList.contains("toggled")) {
            ...
            for (let i = 0, len = mobileSubmenuCustom.length; i < len; i++) {
              mobileSubmenuCustom[i].classList.remove(
                "animate__animated",
        ...
        menuButton.addEventListener("click", function () {
          if (mainMenu.classList.contains("toggled")) {
            ...
            for (let i = 0, len = mobileSubmenu.length; i < len; i++) {
              mobileSubmenu[i].classList.remove(
                "animate__animated",
                "animate__slideInLeft",
                "animate__slideOutLeft"
              );
  ...
  let slides1 = document.querySelectorAll(
    ".single.slider #gallery-1 .gallery-item"
  );
  let slides2 = document.querySelectorAll(
    ".single.slider #gallery-2 .gallery-item"
  );
  let slides3 = document.querySelectorAll(
    ".single.slider #gallery-3 .gallery-item"
  );
  let slides4 = document.querySelectorAll(
    ".single.slider #gallery-4 .gallery-item"
  );
  let slides5 = document.querySelectorAll(
    ".single.slider #gallery-5 .gallery-item"
  );

  // Block gallery slides
  let slides6 = document.querySelectorAll(
    ".single.slider .wp-block-gallery:nth-of-type(1) .blocks-gallery-item, .single.slider .wp-block-gallery:nth-of-type(1) .wp-block-image"
  );
  let slides7 = document.querySelectorAll(
    ".single.slider .wp-block-gallery:nth-of-type(2) .blocks-gallery-item, .single.slider .wp-block-gallery:nth-of-type(2) .wp-block-image"
  );
  let slides8 = document.querySelectorAll(
    ".single.slider .wp-block-gallery:nth-of-type(3) .blocks-gallery-item, .single.slider .wp-block-gallery:nth-of-type(3) .wp-block-image"
  );
  let slides9 = document.querySelectorAll(
    ".single.slider .wp-block-gallery:nth-of-type(4) .blocks-gallery-item, .single.slider .wp-block-gallery:nth-of-type(4) .wp-block-image"
  );
  let slides10 = document.querySelectorAll(
    ".single.slider .wp-block-gallery:nth-of-type(5) .blocks-gallery-item, .single.slider .wp-block-gallery:nth-of-type(5) .wp-block-image"
  );

  // Next panel buttons
  let nextBtn1 = document.querySelector(
    "#gallery-1 + .slider-button-panel .slider-next"
  );
  let nextBtn2 = document.querySelector(
    "#gallery-2 + .slider-button-panel .slider-next"
  );
  let nextBtn3 = document.querySelector(
    "#gallery-3 + .slider-button-panel .slider-next"
  );
  let nextBtn4 = document.querySelector(
    "#gallery-4 + .slider-button-panel .slider-next"
  );
  let nextBtn5 = document.querySelector(
    "#gallery-5 + .slider-button-panel .slider-next"
  );
  let nextBtn6 = document.querySelector(
    ".wp-block-gallery:nth-of-type(1) + .slider-button-panel .slider-next"
  );
  let nextBtn7 = document.querySelector(
    ".wp-block-gallery:nth-of-type(2) + .slider-button-panel .slider-next"
  );
  let nextBtn8 = document.querySelector(
    ".wp-block-gallery:nth-of-type(3) + .slider-button-panel .slider-next"
  );
  let nextBtn9 = document.querySelector(
    ".wp-block-gallery:nth-of-type(4) + .slider-button-panel .slider-next"
  );
  let nextBtn10 = document.querySelector(
    ".wp-block-gallery:nth-of-type(5) + .slider-button-panel .slider-next"
  );

  // Previous panel buttons
  let previousBtn1 = document.querySelector(
    "#gallery-1 + .slider-button-panel .slider-previous"
  );
  let previousBtn2 = document.querySelector(
    "#gallery-2 + .slider-button-panel .slider-previous"
  );
  let previousBtn3 = document.querySelector(
    "#gallery-3 + .slider-button-panel .slider-previous"
  );
  let previousBtn4 = document.querySelector(
    "#gallery-4 + .slider-button-panel .slider-previous"
  );
  let previousBtn5 = document.querySelector(
    "#gallery-5 + .slider-button-panel .slider-previous"
  );
  let previousBtn6 = document.querySelector(
    ".wp-block-gallery:nth-of-type(1) + .slider-button-panel .slider-previous"
  );
  let previousBtn7 = document.querySelector(
    ".wp-block-gallery:nth-of-type(2) + .slider-button-panel .slider-previous"
  );
  let previousBtn8 = document.querySelector(
    ".wp-block-gallery:nth-of-type(3) + .slider-button-panel .slider-previous"
  );
  let previousBtn9 = document.querySelector(
    ".wp-block-gallery:nth-of-type(4) + .slider-button-panel .slider-previous"
  );
  let previousBtn10 = document.querySelector(
    ".wp-block-gallery:nth-of-type(5) + .slider-button-panel .slider-previous"
  );

  let slideshowBtn1 = document.querySelector(
    "#gallery-1 + .slider-button-panel .slider-startshow"
  );
  let slideshowBtn2 = document.querySelector(
    "#gallery-2 + .slider-button-panel .slider-startshow"
  );
  let slideshowBtn3 = document.querySelector(
    "#gallery-3 + .slider-button-panel .slider-startshow"
  );
  let slideshowBtn4 = document.querySelector(
    "#gallery-4 + .slider-button-panel .slider-startshow"
  );
  let slideshowBtn5 = document.querySelector(
    "#gallery-5 + .slider-button-panel .slider-startshow"
  );
  let slideshowBtn6 = document.querySelector(
    ".wp-block-gallery:nth-of-type(1) + .slider-button-panel .slider-startshow"
  );
  let slideshowBtn7 = document.querySelector(
    ".wp-block-gallery:nth-of-type(2) + .slider-button-panel .slider-startshow"
  );
  let slideshowBtn8 = document.querySelector(
    ".wp-block-gallery:nth-of-type(3) + .slider-button-panel .slider-startshow"
  );
  let slideshowBtn9 = document.querySelector(
    ".wp-block-gallery:nth-of-type(4) + .slider-button-panel .slider-startshow"
  );
  let slideshowBtn10 = document.querySelector(
    ".wp-block-gallery:nth-of-type(5) + .slider-button-panel .slider-startshow"
  );
  ...
  let addMaterialInk = (event) => {
    ...
    const diameter = Math.max(
      materialElement.clientWidth,
      materialElement.clientHeight
    );
  ...
  if (bodyDiv.classList.contains("animate")) {
    window.addEventListener("load", () => {
      ...
      const buttons = document.querySelectorAll(
        'button:not(.menu-down-arrow), input[type="button"], .wp-block-button__link'
      );
      const menuItems = document.querySelectorAll(
        ".main-navigation .menu-item a, .main-navigation .page_item a"
      );
    ...
    window.addEventListener("resize", () => {
      var timeOut = setTimeout(function () {
        // Delay rendering/event so that event doesn't fire multiple times
        animateMenu();
      }, 250);
  ...
  if (
    bodyDiv.classList.contains("animate") &&
    !bodyDiv.classList.contains("rtl")
  ) {
    window.addEventListener("load", () => {
      animateMenu();
      animateSearchbar();
