...
function the_mx_enqueue_scripts()
{
    ...
    if (the_mx_example_is_amp()) { // Don't load animate.css on AMP pages
...
{
    include get_template_directory() . '/inc/noscript.php';
}
...
function the_mx_block_styles()
{
    wp_enqueue_script(
        'the-mx-block-styles',
        get_stylesheet_directory_uri() . '/js/source/block-styles.js',
        array('wp-blocks', 'wp-dom'),
        filemtime(get_stylesheet_directory() . '/js/source/block-styles.js'),
        true
    );
}
...
function the_mx_example_is_amp()
{
